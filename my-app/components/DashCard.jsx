...
const DashCard = ({title, stat, icon, comparison }) => {
  return (
    <div className='w-[16rem] h-[8rem] text-white bg-neutral-900 hover:ring-1 flex flex-col items-start gap-1 justify-between hover:ring-neutral-800   text-center p-4 rounded-md hover:scale-[5px] transition'>
